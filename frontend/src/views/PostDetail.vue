...
const postData = ref({
  ...
  userId: 1,
  nickName: '小雪',
  avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=postdetail1',
  level: 28,
  vip: true,
  content: '今天王者连赢五局，超开心！分享一下今天的战绩～',
  images: [
    'https://api.dicebear.com/7.x/bottts/svg?seed=postimg2',
    'https://api.dicebear.com/7.x/bottts/svg?seed=postimg3'
  ],
  tagName: '游戏',
  likes: 128,
  comments: 32,
